  ...
  switch (action.type) {
    ...
    case 'TOGGLE_TODO':
      return state.map(todo =>
        (todo.id === action.id)
          ? Object.assign(todo, {completed: !todo.completed}) // {...todo, completed: !todo.completed}
          : todo
      )
    default:
      return state
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__todos__ = __webpack_require__(227);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__visibilityFilter__ = __webpack_require__(228);
