...
export class DataActions {
  ...
  fetchData (type = 'GET_ISSUES', data: {issuekey: string, commentid: number, input: object}) {
  ...
  receiveIssues (json: { issues: Issue[] }) {
    this.ngRedux.dispatch({ type: DataActions.RECEIVE_ISSUES, issues: json.issues });
  }

  receiveOK (status: object) {
